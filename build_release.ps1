...
$gppCommand = "g++ main.cpp OverlayWindow.cpp Overlay_Rendering.cpp ConfigLoader.cpp LLMClient.cpp ConfigDialog.cpp AudioCapture.cpp Screenshot_Win.cpp Logger.cpp Updater.cpp $resObj -o $cppOutput -mwindows -static -DUNICODE -D_UNICODE -lwinhttp -lcomctl32 -lgdiplus -lcrypt32 -lole32 -lshell32 -ldwmapi"
