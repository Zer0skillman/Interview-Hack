...
Current version: **2.5.2**. Single executable on each platform — Win32 `.exe` (~4 MB) or macOS `.app` bundle (~330 KB binary, frameworks dynamically linked). No installer, no Python, no runtime.
...
1. Download `Interview-Hack-v2.5.2-windows.zip` from the [latest release](https://github.com/Zer0skillman/Interview-Hack/releases/latest)
2. Extract anywhere
3. Run `overlay.exe`
...
1. Download `Interview-Hack-v2.5.2-macos.zip` from the [latest release](https://github.com/Zer0skillman/Interview-Hack/releases/latest)
